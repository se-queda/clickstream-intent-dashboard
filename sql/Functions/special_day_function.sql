DROP FUNCTION IF EXISTS clickstream.get_special_day_effect(TEXT[], TEXT[], BOOLEAN, INT[], INT[], INT[], INT[]);
...
BEGIN
    RETURN QUERY
    SELECT
        s.specialday::NUMERIC, -- Explicitly cast the column to NUMERIC
